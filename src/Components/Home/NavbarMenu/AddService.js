...
const AddService = () => {
	...
	<Form  className="  rounded-md  bg-slate-900 shadow-2xl shadow-slate-500 text-white p-8 ng-untouched ng-pristine ng-valid">
		...
		<div>
			...
			<textarea  name='description' type="text" placeholder=" Service Description..." className="block w-full p-5 rounded autoexpand focus:outline-none focus:ring  text-black  focus:ring-violet-400 dark:bg-gray-800"></textarea>
		</div>
		<div>
